...
class LedStates(metaclass=Metaclass_LedStates):
    ...
    def led1(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'led1' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._led1 = value
    ...
    def led2(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'led2' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._led2 = value
    ...
    def led3(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'led3' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._led3 = value
