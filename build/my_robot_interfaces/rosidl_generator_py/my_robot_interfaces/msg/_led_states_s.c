...
bool my_robot_interfaces__msg__led_states__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // led1
    ...
    ros_message->led1 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // led2
    ...
    assert(PyLong_Check(field));
    ros_message->led2 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // led3
    ...
    assert(PyLong_Check(field));
    ros_message->led3 = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * my_robot_interfaces__msg__led_states__convert_to_py(void * raw_ros_message)
{
  ...
  {  // led1
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->led1);
    {
  ...
  {  // led2
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->led2);
    {
  ...
  {  // led3
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->led3);
    {
