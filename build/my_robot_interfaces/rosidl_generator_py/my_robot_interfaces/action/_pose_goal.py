    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_robot_interfaces.action.PoseGoal_Goal')
            logger.debug(
    ...
    def target_position(self, value):
        if __debug__:
            ...
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'target_position' field must be an integer in [-9223372036854775808, 9223372036854775807]"
...
class Metaclass_PoseGoal_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.PoseGoal_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_PoseGoal_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.PoseGoal_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PoseGoal_SendGoal_Request(metaclass=Metaclass_PoseGoal_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'my_robot_interfaces/PoseGoal_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'PoseGoal_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from my_robot_interfaces.action._pose_goal import PoseGoal_Goal
...
class Metaclass_PoseGoal_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.PoseGoal_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_interfaces.action import _pose_goal
...
class PoseGoal_SendGoal(metaclass=Metaclass_PoseGoal_SendGoal):
    from my_robot_interfaces.action._pose_goal import PoseGoal_SendGoal_Request as Request
    from my_robot_interfaces.action._pose_goal import PoseGoal_SendGoal_Response as Response
...
class PoseGoal_GetResult_Response(metaclass=Metaclass_PoseGoal_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'my_robot_interfaces/PoseGoal_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'PoseGoal_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from my_robot_interfaces.action._pose_goal import PoseGoal_Result
...
class Metaclass_PoseGoal_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.PoseGoal_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PoseGoal_GetResult(metaclass=Metaclass_PoseGoal_GetResult):
    from my_robot_interfaces.action._pose_goal import PoseGoal_GetResult_Request as Request
    from my_robot_interfaces.action._pose_goal import PoseGoal_GetResult_Response as Response
...
class Metaclass_PoseGoal_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.PoseGoal_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PoseGoal_FeedbackMessage(metaclass=Metaclass_PoseGoal_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'my_robot_interfaces/PoseGoal_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['my_robot_interfaces', 'action'], 'PoseGoal_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from my_robot_interfaces.action._pose_goal import PoseGoal_Feedback
...
class Metaclass_PoseGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.action.PoseGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class PoseGoal(metaclass=Metaclass_PoseGoal):
    ...
    from my_robot_interfaces.action._pose_goal import PoseGoal_Goal as Goal
    # The result message defined in the action definition.
    from my_robot_interfaces.action._pose_goal import PoseGoal_Result as Result
    # The feedback message defined in the action definition.
    from my_robot_interfaces.action._pose_goal import PoseGoal_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from my_robot_interfaces.action._pose_goal import PoseGoal_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from my_robot_interfaces.action._pose_goal import PoseGoal_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from my_robot_interfaces.action._pose_goal import PoseGoal_FeedbackMessage as FeedbackMessage
