...
class Init_SetLed_Request_led_state
{
public:
  explicit Init_SetLed_Request_led_state(::my_robot_interfaces::srv::SetLed_Request & msg)
  : msg_(msg)
  {}
  ::my_robot_interfaces::srv::SetLed_Request led_state(::my_robot_interfaces::srv::SetLed_Request::_led_state_type arg)
  {
...
public:
  ...
  {}
  Init_SetLed_Request_led_state led_number(::my_robot_interfaces::srv::SetLed_Request::_led_number_type arg)
  {
    msg_.led_number = std::move(arg);
    return Init_SetLed_Request_led_state(msg_);
  }
