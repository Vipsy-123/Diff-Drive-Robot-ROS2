...
#include "rosidl_runtime_c/string.h"  // led_state
#include "rosidl_runtime_c/string_functions.h"  // led_state
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->led_state;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: led_state
  {
    ...
    if (!ros_message->led_state.data) {
      rosidl_runtime_c__String__init(&ros_message->led_state);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->led_state,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'led_state'\n");
      return false;
    }
  }
